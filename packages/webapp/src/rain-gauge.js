...
class RainGauge extends React.Component<{percent: number}> {
    render() {
        const percent = Math.max(0, Math.min(100, this.props.percent));
        ...
        return (
            <svg viewBox="0 0 141 310" version="1.1">
                ...
                >
                    <g id="Group-3" transform="translate(110.000000, 195.000000)">
                        <g id="Group">
                            <path
...
const maxRain = 100;
const AnimatedRainGauge = ({rain = 20}: {rain: number}) => (
